...
//
//            boolean isFilteringAreaValid = sheetWindowController.isFilteringOrSortingAreaValid(filterAreaStartCoordinateStr, filterAreaEndCoordinateStr);
...
//                updatedFilteringRange = sheetWindowController.createRangeToSortOrFilter(filterAreaStartCoordinateStr, filterAreaEndCoordinateStr);
//            }
//
//            boolean isColumnLetterInFilteringArea = sheetWindowController.isColumnLetterInFilteringOrSortingArea(stringWithLetterOfColumnToGetUniqueValuesToFilter, filterAreaStartCoordinateStr, filterAreaEndCoordinateStr);
...
//            List<String> uniqueValuesInSelectedColumn = sheetWindowController.getUniqueValuesForFilteringInSelectedColumnAndRelevantArea(charLetterOfColumnToGetUniqueValuesToFilter, filterAreaStartCoordinateStr, filterAreaEndCoordinateStr);
