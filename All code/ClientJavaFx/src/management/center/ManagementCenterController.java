...
//    // Method to add rows based on HTTP response data
//    public void addRowsFromResponse(List<RowInSheetTable> newRowsToSheetsTable) {
//        allRowsInSheetsTable.addAll(newRowsToSheetsTable);
//    }
//
//    // Method to delete a row based on unique sheetName
//    public void deleteRowBySheetName(String sheetName) {
//        allRowsInSheetsTable.removeIf(rowInSheetTable -> rowInSheetTable.getSheetName().equals(sheetName));
//    }
...
//            permissionRequestNumColumn.setSortType(TableColumn.SortType.ASCENDING);
//            allPermissionsTableView.sort();
